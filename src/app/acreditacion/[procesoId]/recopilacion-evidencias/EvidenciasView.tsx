...
export default function EvidenciasView({
  ...
  const refreshData = async () => {
    ...
    startTransition(async () => {
      await loadMacroData(selectedMacroId);
    });
  };
            ...
            <div className="flex items-center justify-between px-5 py-4 bg-white border-t border-gray-100 shrink-0">
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  onClick={refreshData}
                  disabled={isPending}
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 border border-gray-200 text-[9px] uppercase tracking-wider font-sans font-extrabold rounded-lg shadow-sm transition-all disabled:opacity-50"
                >
